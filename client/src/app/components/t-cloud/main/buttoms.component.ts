...
export class ButtomsComponent implements OnInit {
    ...
    constructor(private router: Router, private annotationsServ: AnnotationsService, private facesservices: FacesService, private datepipe: DatePipe, private pagerService: PagerService) { }
    ...
    public photoUploader: FileUploader = new FileUploader({ url: imgURL, itemAlias: 'photo' });
    ...
    annotate() {
        let res1 = {
            "id": 1,
            "image": "https://ec2-54-210-219-113.compute-1.amazonaws.com/media/perumal/NiceKitchen_RBE1hUp.png",
            "width": 719,
            "height": 487,
            "results": {
                "Object": [
        ...
        let res3 = {
            "id": 3,
            "image": "https://ec2-54-210-219-113.compute-1.amazonaws.com/media/perumal/face_HNN5bcw.jpg",
            "width": 1024,
            "height": 575,
            "results": {
                "Object": [
        ...
        this.router.navigate(['/annotations/dataset/' + 'object' + '/' + this.choosenDataset + '/0']);
