...
@Component({
  selector: 'app-test-your-model',
  templateUrl: './test-your-model.component.html',
  styleUrls: ['./test-your-model.component.scss']
})
export class TestYourModelComponent implements OnInit, OnDestroy {
