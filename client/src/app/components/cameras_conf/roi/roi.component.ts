...
export class ROIComponent implements OnInit {
          ...
          for(let u = 0; u < this.relations.length; u++){
            ...
            if(this.relations[u]['roi_id'] != null &&  this.relations[u]['algo_id'] == params.id){
              ...
              if(this.relations[u]['atributes'] != null){
                this.relations[u]['roi_id'].push(JSON.parse(this.relations[u]['atributes']));
              }
  ...
  point_it(event) {
    ...
    if(event.ctrlKey){
      ...
      if(this.perimeter.length>2 && x > this.perimeter[0]['x'] - 3 && x < this.perimeter[0]['x'] + 3 && y > this.perimeter[0]['y'] - 3 && y < this.perimeter[0]['y'] + 3){
        if(this.id == 8){
          this.close_wrong();
          return false;
        }else if(this.id == 4){
...
close_park(){
if(this.parking.car == true || this.parking.truck == true || this.parking.two_wheeler == true){
  if(this.parking.time != undefined && this.parking.rangeB != undefined && this.parking.rangeE != undefined){
     if(this.selected != undefined){
      for(let e = 0; e < this.polygons.length; e++){
        if(this.selected == e){
          this.polygons[e][this.polygons[e].length - 2] = JSON.stringify(this.parking);
        }
      }
      this.selected = undefined;
...
get(t){
  ...
  this.ctx.beginPath();
  if(t == e){
    this.parking = JSON.parse(this.polygons[e][this.polygons[e].length - 2]);
    this.selected = t;
    this.perimeter = [];
    pred_colour = 'yellow';
  ...
  save(){
    ...
    const params = this.activatedRoute.snapshot.params;
      if(this.relations.length != 0){                
        ...
        if(JSON.stringify(this.relations[u]['roi_id']) == JSON.stringify(this.polygons[t])){
          h = true;
            }
          }
      ...
      for(let e = 0; e < this.relations.length; e++){
        if(this.relations[e]['algo_id'] == this.id && this.relations[e]['roi_id'] == null){
        ...
        if(this.id == 4 || this.id == 8){
          ...
          // for(let i = 0; i < this.rois.length; i++){
            // if(this.relations[e]['roi_id'] == this.rois[i]['id']){
              for(let u = 0; u < this.polygons.length; u++){
                if(JSON.stringify(this.relations[e]['roi_id']) == JSON.stringify(this.polygons[u]) && JSON.parse(this.relations[e]['atributes']) != this.polygons[u][this.polygons[u].length - 2]){
                  this.relation.atributes = JSON.stringify(this.polygons[u][this.polygons[u].length - 2]);
          ...
          for(let l = 0; l <this.polygons[e].length; l++){
            //these parameters is to scalate it according to RoI resolution
            this.polygons[e][l]['x'] = this.polygons[e][l]['x']*this.res_width/this.width;
            this.polygons[e][l]['y'] = this.polygons[e][l]['y']*this.res_height/this.height;
          }
